...
public class Window extends javax.swing.JFrame {
    ...
    boolean userToRobotTankDrive(){
        try {
            /* byte "mod" description
            byte [8] bits 0 0 0 0 0 0 0 0
                the first bit is the stop flag                      {X 0 0 0 0 0 0 0} (X=0=run/X=1=stop)
                the secound bit, left motors forward/backwards flag {0 X 0 0 0 0 0 0} (X=0=backward/X=1=forward)
                the third bit, right motors forward/backwards flag  {0 0 X 0 0 0 0 0} (X=0=backward/X=1=forward)
            */
             byte mod = 0;
             short bleft = 0;
             short bright = 0;
            ...
            if (ct == 1) { // Keyboard
                if (nws == 0 && nad == 0) { // 'nws' == none 'w' key or 's' key
                    commandField.setText("STOP");
                    mod = setBit(mod, true, 0); // stop flag
                    bleft=0;
                    bright=0;
                } else if (nws == 1 && nad == 0) {
                    commandField.setText("Forward");
                    mod = setBit(mod, false, 0); // stop flag
                    mod = setBit(mod, true, 1);  // left motor direction
                    mod = setBit(mod, true, 2);  // right motor direction
                    bleft=125;
                    bright=125;
                } else if (nws == 2 && nad == 0) {
                    commandField.setText("Backward");
                    mod = setBit(mod, false, 0);// stop flag
                    mod = setBit(mod, false, 1); // left motor direction
                    mod = setBit(mod, false, 2); // right motor direction
                    bleft=125;
                    bright=125;
                } else if (nws == 0 && nad == 1) {
                ...
                this.stopFlagTxtBox.setText(""+isBitSet(mod, 0));
                this.leftDirTxtBox.setText(""+isBitSet(mod, 1));
                this.rightDirTxtBox.setText(""+isBitSet(mod, 2));
                this.leftPowerTxtBox.setText(""+bleft);
                this.rightPowerTxtBox.setText(""+bright);
                server.send("["+(char)mod+""+(char)bleft+""+(char)bright+"]");
                ...
                setBit(mod, false, 0);// stop flag
                setBit(mod, true, 1); // left motor direction
                setBit(mod, true, 2); // right motor direction
                server.send("["+mod+""+(int)left+""+(int)right+"]");
    ...
    private void initComponents() {
        ...
        stopFlagTxtBox = new javax.swing.JTextField();
        leftDirTxtBox = new javax.swing.JTextField();
        leftPowerTxtBox = new javax.swing.JTextField();
        rightDirTxtBox = new javax.swing.JTextField();
        jTextField5 = new javax.swing.JTextField();
        jTextField6 = new javax.swing.JTextField();
        jTextField7 = new javax.swing.JTextField();
        jTextField8 = new javax.swing.JTextField();
        jTextField9 = new javax.swing.JTextField();
        rightPowerTxtBox = new javax.swing.JTextField();
        ...
        stopFlagTxtBox.setMinimumSize(new java.awt.Dimension(40, 20));
        stopFlagTxtBox.setPreferredSize(new java.awt.Dimension(40, 20));

        leftDirTxtBox.setMinimumSize(new java.awt.Dimension(40, 20));
        leftDirTxtBox.setPreferredSize(new java.awt.Dimension(40, 20));

        leftPowerTxtBox.setMinimumSize(new java.awt.Dimension(40, 20));
        leftPowerTxtBox.setPreferredSize(new java.awt.Dimension(40, 20));

        rightDirTxtBox.setMinimumSize(new java.awt.Dimension(40, 20));
        rightDirTxtBox.setPreferredSize(new java.awt.Dimension(40, 20));

        jTextField5.setText("stop flag");
        ...
        jTextField6.setText("left dir");

        jTextField7.setText("right dir");

        jTextField8.setText("left power");

        jTextField9.setText("right power");

        rightPowerTxtBox.setEditable(false);
        rightPowerTxtBox.setDisabledTextColor(new java.awt.Color(51, 255, 255));
        rightPowerTxtBox.setDragEnabled(true);
        rightPowerTxtBox.setMinimumSize(new java.awt.Dimension(40, 20));
        rightPowerTxtBox.setPreferredSize(new java.awt.Dimension(40, 20));
        ...
        axisXYPanelLayout.setHorizontalGroup(
            ...
            .addGroup(axisXYPanelLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTextField8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jTextField7, javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jTextField6, javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jTextField5, javax.swing.GroupLayout.Alignment.TRAILING)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(axisXYPanelLayout.createSequentialGroup()
                        .addComponent(leftPowerTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(axisXYPanelLayout.createSequentialGroup()
                        .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(rightDirTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(leftDirTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(stopFlagTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(104, Short.MAX_VALUE))))
            .addGroup(axisXYPanelLayout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(jTextField9, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(rightPowerTxtBox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        axisXYPanelLayout.setVerticalGroup(
            axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(axisXYPanelLayout.createSequentialGroup()
                .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(stopFlagTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(axisXYPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rightPowerTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextField9, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(95, 95, 95))
        );
    ...
    private javax.swing.JTextField leftDirTxtBox;
    private javax.swing.JTextField leftPowerTxtBox;
    private javax.swing.JTextField rightDirTxtBox;
    private javax.swing.JTextField rightPowerTxtBox;
    private javax.swing.JTextField stopFlagTxtBox;
